...
public class BshLambdaTest {
    ...
    // Object deflate(Object obj) {
    //     if (obj == null || !obj.getClass().isArray()) return obj;
    //     List<Object> list = new ArrayList<>();
    //     for (int i = 0; i < Array.getLength(obj); i++) list.add(deflate(Array.get(obj, i)));
    //     return list;
    // }
    ...
    public void test_method_reference_not_assignable_invalid_params() throws Throwable {
        ...
        boolean assignable = bshLambda.isAssignable(BiFunction.class, Types.JAVA_BASE_ASSIGNABLE);
    ...
    public void test_method_reference_of_constructor_not_assignable_invalid_return_type() throws Throwable {
        BshLambda bshLambda = (BshLambda) TestUtil.eval("Integer::new");
        boolean assignable = bshLambda.isAssignable(ListGenerator.class, Types.JAVA_BASE_ASSIGNABLE);
        Assert.assertFalse(assignable);
    }
    ...
    public void test_lambda_expression_not_assignable_invalid_params_length() throws Throwable {
        BshLambda bshLambda = (BshLambda) TestUtil.eval("() -> {}");
        Assert.assertFalse(bshLambda.isAssignable(Consumer.class, Types.JAVA_BASE_ASSIGNABLE));
    }
    ...
    public void test_cant_create_functional_interface_wrapper() throws Throwable {
        ...
        try (MockedStatic<BshLambda> mockedStatic = Mockito.mockStatic(BshLambda.class)) {
            ...
            mockedStatic.when(() -> BshLambda.methodFromFI(Runnable.class)).thenReturn(Runnable.class.getMethod("run"));
    ...
    public void test() throws Throwable {
        ...
        try {
            // TestUtil.eval("new ArrayList<>()::equals");
            // BshLambda bshLambda = (BshLambda) TestUtil.eval("() -> {}");
            // System.out.println("Integer.name: " + Integer.class.getConstructors()[0].getName());
            // "Static final variable _staticVar is not initialized."
            // Object result = TestUtil.eval("(int num) -> {}");
            // Object result = TestUtil.eval("void func(int arg1) {}");
            // System.out.println("result: " + result);
            // System.out.println("result: " + Arrays.asList((Object[]) result));
            // TestUtil.eval(
            //     "import java.util.stream.Collectors;",
            //     "List<String> nums = Arrays.asList(\"1\", \"2\", \"3\", \"4\", \"5\", \"6\", \"7\", \"8\");",
            //     "return nums.stream().map(Integer::new).collect(Collectors.toList());"
            ...
            //     "    ParentChild(int a) { super(a); }",
            //     "    void setID(int a) { id = a * 5; }",
            //     "}",
            //     "class Parent extends ParentChild {",
            //     "    Parent(int a) { super(a); }",
            //     "    public int setID(int a) { id = a * 4; }",
            //     "}",
            //     "return new Parent(3).getID();",
            ...
            //     "    void setID(a) { id = a * 7; }",
            //     "}",
            //     "return new Parent().getID();"
                
            //     // assertEquals(21, new Parent().getID());
            //     // "10.435f.compareTo(null)"
            //     // "b = true;",
            //     // "b.booleanValue() == true.booleanValue()"
            //     // "(Object) 1"

            //     // "class MyClass {",
            //     // "   public static void func() { throw new NullPointerException(\"\"); }",
            //     // "}",
            //     // "MyClass.func()"
            //     // "MyClass.forNum((num) -> nums2.add(num * 2));"
            //     // "pout = new PipedOutputStream();",
            //     // "pout.write(new byte[0]);"
            //     // "class POut1 { public int write(byte[] bytes) { return 0; } }",
            //     // "class POut extends POut1 {}",
            //     // "pout = new POut();",
            //     // "pout.write(new byte[0]);"
            // );
            // System.out.println("result: " + result);
            // System.out.println("valid: " + (new Integer(12).equals(result)));
            // System.out.println("valid: " + (new Integer(21).equals(result)));
