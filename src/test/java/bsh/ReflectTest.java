...
//             "return T7.class;"
//         );
//         BshLocalMethod sm2 = Reflect.getMethod(type, "sm2", new Class<?>[0]);
...
//             "return new T9();"
//         );
//         BshLocalMethod m2 = Reflect.getMethod(object, "m2", new Class<?>[0]);
...
//         );
//         NameSpace ns = Reflect.getThisNS(object);
//         BshLocalMethod m2 = Reflect.getMethod(ns, "m2", new Class<?>[0]);
//         assertNotNull("get method m2 is not null", m2);
//         assertEquals("method get is m2", "m2", m2.getName());
//         assertNotNull("gen method sm2 is not null",
...
//             "return T11.class;"
//         );
//         BshLocalMethod m2 = Reflect.getDeclaredMethod(type, "m2", new Class<?>[0]);
//         assertNotNull("get method m2 is not null", m2);
//         assertEquals("method get is m2", "m2", m2.getName());
//         assertNotNull("gen method sm2 is not null",
...
//             "return T12.class;"
//         );
//         BshLocalMethod[] meths = Reflect.getMethods(type);
//         assertThat("3 Methods", meths, arrayWithSize(3));
//         assertThat("methods has [sm1, sm2, sm3]",
//                 Stream.of(meths).map(BshLocalMethod::getName).collect(Collectors.toList()),
//                 hasItems("sm1", "sm2", "sm3"));
//     }
...
//             "return new T13();"
//         );
//         BshLocalMethod[] meths = Reflect.getMethods(object);
...
//             );
//         NameSpace ns = Reflect.getThisNS(type);
//         BshLocalMethod[] meths = Reflect.getMethods(ns);
//         assertThat("3 Methods", meths, arrayWithSize(3));
//         assertThat("methods has [sm1, sm2, sm3]",
//                 Stream.of(meths).map(BshLocalMethod::getName).collect(Collectors.toList()),
//                 hasItems("sm1", "sm2", "sm3"));
...
//                 "return T15.class;"
//             );
//         BshLocalMethod[] meths = Reflect.getDeclaredMethods(type);
//         assertThat("6 Methods", meths, arrayWithSize(6));
//         assertThat("methods has [sm1, sm2, sm3, m1, m2, m3]",
//                 Stream.of(meths).map(BshLocalMethod::getName).collect(Collectors.toList()),
//                 hasItems("sm1", "sm2", "sm3", "m1", "m2", "m3"));
