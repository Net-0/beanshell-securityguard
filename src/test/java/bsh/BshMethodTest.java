...
//        class SubMethod extends BshLocalMethod {
...
//              super(name, returnType, paramNames, paramTypes, paramModifiers, new Class<?>[0],
...
//        final BshLocalMethod subInst =
//             new SubMethod(name, Integer.class, new String[] {}, new Class[] {},
//                     new Modifiers[] {}, null, null, null);
//        final BshLocalMethod supInst =
//             new BshLocalMethod(name, Integer.class, new String[] {}, new Class[] {},
//                     new Modifiers[] {}, new Class<?>[0], null, null, null, false);
...
//        final String name = "testMethod";
//        final BshLocalMethod method1 = new BshLocalMethod(name,
//              Integer.class, new String[0], new Class[0], new Modifiers[0], new Class<?>[0], null, null, null, false);
//        final BshLocalMethod method2 = new BshLocalMethod(name,
//              Integer.class, new String[0], new Class[0], new Modifiers[0], new Class<?>[0], null, null, null, false);
