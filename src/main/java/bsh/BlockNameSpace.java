...
/*
    ...
    now.
*/
// TODO: faz sentido existir essa classe ?
class BlockNameSpace extends NameSpace {
    ...
    @Override
    public Object setLocalVariable(String name, java.lang.reflect.Type type, Object value, Modifiers mods) throws UtilEvalError {
        if (this.hasLocalVariable(name))
