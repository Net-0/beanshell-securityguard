...
public interface BshModifier {
    ...
    // public static final int INTERFACE_METHOD_MODIFIERS = 0b00000000000000001001110111111111; // PUBLIC | PRIVATE | PROTECTED | ABSTRACT | STATIC | FINAL | SYNCHRONIZED | NATIVE | STRICT | BRIDGE | VARARGS | SYNTHETIC | MANDATED
