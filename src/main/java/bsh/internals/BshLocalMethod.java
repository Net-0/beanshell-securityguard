...
*/
// TODO: faz sentido essa parada estar aqui ? um local-method é realmente algo interno que não deveriam ter acesso ?
public final class BshLocalMethod implements Serializable, Cloneable, BshClassManager.Listener {

    @FunctionalInterface
    public static interface BodyFunction<R> {
        R apply(CallStack callStack, Object ...args) throws EvalError;
    }
    ...
    */
    ...
    // TODO: review it
    public BshLocalMethod(int modifiers, Type genericReturnType, String name, BshParameter[] parameters, Type[] genericExceptionTypes, BodyFunction<?> body, NameSpace declaringNameSpace) {
        this.modifiers = modifiers;
        // TODO: ver isso do getRawType 
    ...
    public boolean equals(Object o) {
        ...
        // TODO: não é melhor comprar o name e descriptor ( pois ele já possui os parâmetros e return type ) ? talvez usar a signature ao invés do descriptor ( pois a signature possui generics e Exceptions ) ?
    ...
    // TODO: see it!
    // TODO: tlvz fazer um hashCode do name e descriptor ( ou signature ) ?
    @Override
    public int hashCode() {
        int h = name.hashCode() + getClass().hashCode();
        for (final BshParameter param : this.parameters)
            h += 3 + param.getType().hashCode();
        return h + this.parameters.length;
    }
