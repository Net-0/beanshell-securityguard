...
public class BshConstructor {
    ...
    public BshConstructor(int modifiers, BshParameter[] parameters, Type[] genericExceptionTypes, ConstructorChainKind constructorChainKind, Supplier<Object[]> constructorChainArgs, BshConsumer<CallStack> body) {
