...
class BSHPrimaryExpression extends SimpleNode {
    ...
    public Object eval(CallStack callStack, Interpreter interpreter) throws EvalError {
        // TODO: ver esse 'new ClassIdentifier()'
        // TODO: ver esse 'baseObj' não sendo final!
        Object baseObj = this.jjtGetChild(0) instanceof BSHType
                            // TODO: ver isso
                            ? new ClassIdentifier( Types.getRawType( this.<BSHType>jjtGetChild(0)._toType(callStack, interpreter) ) ) // TODO: se usarmos o ._toClass() não daria problema tipo para 'List<?>.class' ?
