...
public final class Reflect {
    ...
    protected static void setField(Object thisArg, String fieldName, Object value, CallStack callStack) throws ReflectError, SecurityError, NoSuchFieldException, UtilEvalError {
        if (thisArg == Primitive.NULL) // TODO: validar thisArg == null tb ?
    ...
    protected static Object invokeLocalMethod(NameSpace nameSpace, String methodName, Object[] args, CallStack callStack) throws ReflectError, SecurityError, TargetError, NoSuchMethodException {
        ...
        for (NameSpace ns = nameSpace; ns != null; ns = ns.getParent()) {
            ...
            if (nameSpace.declaringClass != null)
                try {
                    return Reflect.invokeStaticMethod(nameSpace.declaringClass.toClass(), methodName, args, callStack);
                } catch (NoSuchMethodException e) {}
            if (nameSpace._this != null)
                try {
                    return Reflect.invokeMethod(nameSpace._this, methodName, args, callStack);
                } catch (NoSuchMethodException e) {}
            ...
            for (final Name className: classNames)
                try {
                    return Reflect.invokeStaticMethod(className.toClass(), methodName, args, callStack);
                } catch (NoSuchMethodException e) {
        ...
        // if (localMethod == null) {
            String msg = String.format("There is no such method: %s(%s)", methodName, String.join(", ", Types.prettyNames(argsTypes)));
            throw new NoSuchMethodException(msg);
        // }
    ...
    // TODO: adicionar overload, um onde receba argsTypes para melhoria de performance de outros que usam este utilitário!
    public static Object invokeStaticMethod(Class<?> _class, String methodName, Object[] args, CallStack callStack) throws ReflectError, SecurityError, TargetError, NoSuchMethodException {
