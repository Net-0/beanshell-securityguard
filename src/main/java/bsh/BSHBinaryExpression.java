...
class BSHBinaryExpression extends SimpleNode implements ParserConstants {
    ...
    // TODO: reescrever esse método ?
    public Object eval( CallStack callstack, Interpreter interpreter) throws EvalError {
        final Object lhs = jjtGetChild(0).eval(callstack, interpreter);
        ...
        if (kind == INSTANCEOF) {
            ...
            final Type rhs = this.<BSHType>jjtGetChild(1)._toType(callstack, interpreter);
            ...
            */
            ...
            // TODO: ver onde usamos Types.getRawType() para recebermos o Type como argumento na verdade ?
            // General case - perform the instanceof based on assignable
            return bsh.Types.isJavaBaseAssignable(Types.getRawType(rhs), lhs.getClass()) ? Primitive.TRUE : Primitive.FALSE;
        }
    ...
    private Class<?> getVariableAtNode(int index, CallStack callStack, boolean strictJava) throws EvalError, UtilEvalError {
        ...
        if (jjtGetChild(index).jjtGetNumChildren() > 0 && (nameNode = jjtGetChild(index).jjtGetChild(0)) instanceof BSHAmbiguousName) {
            ...
            return bsh.Types.getType(value);
        }
        return null;
    }
