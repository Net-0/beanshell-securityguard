...
public class This implements java.io.Serializable, Runnable {
    ...
    public void run() {
        try {
            Reflect.invokeMethod(this, "run", Reflect.ZERO_ARGS, new CallStack());
        } catch (Throwable e) {
    ...
    public This(final Object _this, final boolean strictJava) {
        // Note: we start 'constructing' as 'true' because wer're building it yet, then we change to 'false'
        this(_this, _this.getClass(), strictJava, true);
    ...
    private This(final Object _this, final Class<?> thisClass, final boolean strictJava, boolean constructing) {
    ...
    protected static boolean isObjectWrapper(Object obj) {
    ...
    public void setConstructing(boolean constructing) {
        ...
        if (!this.constructing) throw new IllegalAccessError("Can't set constructing 'cause it's already false!");
        if (constructing) throw new IllegalArgumentException("Can't set constructing to true!");
    ...
    protected boolean canSetFinalField(String fieldName) {
        ...
        return this.constructing && this.finalFieldsSet.add(fieldName);
    }
    ...
    protected This getSuper() {
        ...
        if (this.isNameSpaceWrapper) {
            ...
            return new This(this._this, superClass, this.strictJava, false);
        }
    }
